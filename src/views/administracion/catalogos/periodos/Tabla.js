    ...
    const eliminarPeriodo = (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                DataSourcePeriodo.deletePeriodo(id);
                setTableUpdate(true);
                Swal.fire('¡Periodo de estudios eliminado!');
            }
        });
    };
                                    ...
                                    return (
                                        <TableRow hover tabIndex={-1} key={row.id} selected={isItemSelected}>
                                            ...
                                            <TableCell aling="center">
                                                <IconButton>
                                                    <ModalEditar idPeriodo={row} setTableUpdate={setTableUpdate} />
                                                </IconButton>

                                                <IconButton title="Eliminar" onClick={() => eliminarPeriodo(row.id)}>
                                                    <DeleteIcon />
                                                </IconButton>
                                            </TableCell>
                                        </TableRow>
