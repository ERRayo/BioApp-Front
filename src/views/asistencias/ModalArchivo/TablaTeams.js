...
import EnhancedTableHead from './HeadTableTeams';
...
export default function TablaTeams({ datos }) {
                                ...
                                .map((row, index) => {
                                    ...
                                    return (
                                        <TableRow
                                            hover
                                            tabIndex={-1}
                                            key={`${row.Nombre}-${row.apellido_paterno}-${row.apellido_materno}`}
